<div class="xs">
    ...
    <div class="well1 white">
        ...
        <form class="form-floating" action="<?php echo base_url()?>service/update/<?php echo $service->id;?>" method="post" enctype="multipart/form-data" >
            <fieldset>
                <div class="form-group">
                    <label class="control-label">Title</label>
                    <input type="text" name="title" value="<?php echo $service->title; ?>" class="form-control1">
                    <?php echo form_error('title','<span class="text-danger">', '</span>'); ?>
                </div>
                <div class="form-group">
                    <label class="control-label">Description</label>
                    <textarea name="description"  cols="30" rows="5" class="form-control"><?php echo $service->description; ?></textarea>
